...
export default function CollectiveKnowledge() {
  return (
    <section className="w-full max-w-6xl mx-auto px-4 py-16 mt-10" id="community-chats">
      {/* Section Header */}
      <div className="text-center mb-12">
        ...
        <p className="text-[#414845] max-w-xl mx-auto text-lg leading-relaxed">
          Engagement that grows. Join thousands of drivers in specialized circles 
          built around shared passion and common routes.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[500px]">
        ...
        <div className="md:col-span-2 bg-[#e0e3e1] rounded-[2.5rem] p-10 flex flex-col justify-between overflow-hidden">
          <div>
            ...
            <p className="text-[#414845] mb-8 max-w-md">
              Connect with the "Subaru Owners Collective" or the "Land Rover Archivists." 
              Tailored advice, parts sourcing, and community events for your specific make.
            </p>
          </div>
        ...
        <div className="bg-[#011f16] rounded-[2.5rem] p-8 md:p-10 flex flex-col justify-between text-white overflow-hidden">
          <div>
            <div className="mb-6">
              <MessageSquare className="w-8 h-8 text-emerald-400" strokeWidth={1.5} />
            </div>
