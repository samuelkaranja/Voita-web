...
export default function DigitalRegistryCard() {
  return (
    <div className="bg-white rounded-4xl flex flex-col lg:flex-row min-h-[450px] overflow-hidden transition group-hover:shadow-md">
      ...
      <div className="flex-1 p-8 lg:p-12 flex flex-col justify-between">
        <div className="space-y-8">
          ...
          <div>
            <h3 className="text-[#0d2b1f] text-2xl lg:text-3xl font-bold">
              Digital Registry (Profile)
            </h3>

            <p className="text-[#4a5a52] text-sm lg:text-base leading-relaxed mt-3 max-w-lg">
              Complete car and driver management in one place. Track everything from mechanical specs to legal renewals with automated intelligence.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-6 pt-4">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                {carDetails.map((item) => (
                  <li key={item} className="flex items-center gap-2 text-sm text-[#4a5a52]">
        ...
        <div className="bg-[#e8ebea] w-full rounded-4xl flex items-center justify-center px-10 py-2">
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-black/5 w-full max-w-[280px] p-6 space-y-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[#0d2b1f] text-sm font-bold">KCB 001A</p>
                <p className="text-[#7a8a82] text-[10px] font-bold uppercase">
                  Toyota Land Cruiser
                </p>
              </div>
            </div>
