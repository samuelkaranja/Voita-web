...
export default function EmergencyDirectory() {
  return (
    <div className="min-h-screen mt-10" id="emergency">
      <div className="max-w-6xl mx-auto bg-[#f1f4f2] rounded-[3rem] p-8 md:p-12">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between mb-8 gap-4">
          <div className="max-w-xl space-y-4">
            ...
            <h1 className="text-4xl font-extrabold text-[#001810] mb-2">Emergency Help Directory</h1>
            <p className="text-slate-600 max-w-md">
              The Archive keeps your safety prioritized. Access vital contacts across Kenya with one-tap visibility.
            </p>
          </div>
          <div className="flex items-center gap-2 bg-slate-100 px-4 py-2 rounded-full self-start">
            ...
            <span className="text-xs font-bold text-slate-700 tracking-wider">SYSTEM STATUS: ONLINE</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {directoryData.map((item, index) => (
            <div key={index} className="bg-white border border-slate-100 p-6 rounded-2xl hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="font-bold text-lg text-[#001810] mb-1">{item.title}</h3>
