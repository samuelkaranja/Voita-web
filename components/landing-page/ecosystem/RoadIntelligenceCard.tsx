...
export default function RoadIntelligenceCard() {
  return (
    <div className="bg-white border border-gray-100 rounded-3xl overflow-hidden flex flex-col md:flex-row min-h-[300px] lg:col-span-2">
      {/* Left Content */}
      <div className="p-8 flex-1 flex flex-col justify-between">
        ...
        <div className="flex gap-2 mt-6">
          <span className="bg-[#e7f6ed] text-[#0d6e4a] text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">
            Grade A
          </span>
          <span className="bg-[#fef9c3] text-[#854d0e] text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider">
            Grade B
          </span>
        </div>
      </div>
